...
These instructions apply to the entire `abdulbasit742/ai-agent-backend-11` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **ai-agent-backend-11**.
